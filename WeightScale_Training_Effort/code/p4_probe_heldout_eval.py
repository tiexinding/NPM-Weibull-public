...
held=clean[2400000:2400000+HELD_N].astype(np.int64)
nblk=len(held)//BLK
...
rows=[]; outpath=f"{OUT}/p4_heldout_data.json"
i=0
...
plt.tight_layout(); fig.savefig(f"{OUT}/p4_probe_heldout.png",dpi=160,bbox_inches="tight")
print("\nWROTE",f"{OUT}/p4_probe_heldout.png",flush=True)
